    ...
    public class ClientMappersTests
    {
        ...
        public void duplicates_properties_in_db_map()
        {
            var entity = new IdentityServer4.Fsql.Storage.Entities.Client
            {
                ...
                {
                    new IdentityServer4.Fsql.Storage.Entities.ClientProperty{Key = "foo1", Value = "bar1"},
                    new IdentityServer4.Fsql.Storage.Entities.ClientProperty{Key = "foo1", Value = "bar2"},
                }
            };
